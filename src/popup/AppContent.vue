<template>
  <div class="app-container">
    ...
    <TicketList
      ...
      :selected-project="tickets.selectedProject.value"
      :available-projects="tickets.availableProjects.value"
      @update:search-query="tickets.searchQuery.value = $event"
      @update:selected-project="tickets.selectedProject.value = $event"
      @toggle-selection="handleToggleSelection"
      @open-modal="handleOpenModal"
      @toggle-bookmark="handleToggleBookmark"
